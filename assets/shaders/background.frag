...
void main()
{
    ...
    // ------------------------------------------------------------
    // Палитра Рафталии:
    // Warm Ivory / Parchment  — мягкость, светлая кожа, человечность.
    // Chestnut Amber          — волосы, тепло, чувство дома.
    // Rosewood Wine           — верность, сердце, воля.
    // Dusty Plum              — память, боль, зрелая тень.
    // Muted Ochre             — кожа, ремесло, боевая устойчивость.
    // Dawn Blue               — надежда, воздух, восстановленное доверие.
    // Soft Silver             — сталь, броня, дисциплина.
    // ------------------------------------------------------------
